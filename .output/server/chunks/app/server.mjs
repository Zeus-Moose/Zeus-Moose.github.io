import { getCurrentInstance, version, toRef, isRef, inject, shallowRef, computed, reactive, isReadonly, useSSRContext, createApp, defineAsyncComponent, nextTick, provide, onErrorCaptured, onServerPrefetch, unref, withCtx, createVNode, defineComponent, h, Suspense, Transition } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_...slug_-a29d44ab.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-3825381e.mjs').then((m) => m.default || m)
  },
  {
    name: "portfolio-slug",
    path: "/portfolio/:slug(.*)*",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_...slug_-59816926.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-990eceed.mjs').then((m) => m.default || m),
  error: () => import('./_nuxt/error-41c18ca5.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-bd0e9273.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useRoute as a, useState as b, createError as c, useNuxtApp as d, entry$1 as default, useRequestEvent as e, useRouter as f, navigateTo as n, useRuntimeConfig as u };
