...
import { u as useAsyncData, q as queryContent, e as encodeQueryParams, j as jsonStringify, a as useCookie } from './query-0f2fb5d8.mjs';
import { hash } from 'ohash';
import { _ as __nuxt_component_0 } from './nuxt-link-f57cd0d9.mjs';
import { u as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils-926a1a3c.mjs';
import 'ofetch';
import 'hookable';
import 'unctx';
import '@unhead/vue';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-a7e0e15b.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-4227c011.mjs.map
