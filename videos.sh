for file in ./assets/videos/*; do 
    if [ -f "$file" ]; then 
        ...
        ffmpeg -y -i "public/assets/videos/$fileName.mp4" -frames:v 1 "public/assets/images/$fileName-thumb.jpg"
        ...
        ffmpeg -y -i "public/assets/videos/$fileName.mp4" -frames:v 1 "public/assets/images/covers/$fileName-wide.jpg"
        ...
        ffmpeg -y -i "public/assets/videos/$fileName.mp4" -frames:v 1 "public/assets/images/covers/$fileName-tall.jpg"
    fi 
done
